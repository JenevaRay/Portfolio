...
export default function Contact(): JSX.Element {
    ...
    return (
    <Form noValidate validated={validated} onSubmit={handleSubmit} style={style} className='pt-5'>
        <Form.Group className="mb-3" as={Row} controlId="formName">
            <Form.Label column sm="2">Name:</Form.Label>
            <Col sm="10">
                <Form.Control name='name' type="text" required onChange={handleInputChange} minLength={3}/>
            </Col>
        </Form.Group>
        <Form.Group className="mb-3" as={Row} controlId="formEmail">
            <Form.Label column sm="2">Email address:</Form.Label>
            <Col sm="10">
                <Form.Control name='email' type="email" required  placeholder="Enter email" onChange={handleInputChange} />
            </Col>
        </Form.Group>
        <Form.Group className="mb-3" as={Row} controlId="formMessage">
            <Form.Label column sm="2">Message:</Form.Label>
            <Col sm="10">
                <Form.Control name='message' type="textarea" required placeholder="" onChange={handleInputChange} minLength={20} />
            </Col>
        </Form.Group>
